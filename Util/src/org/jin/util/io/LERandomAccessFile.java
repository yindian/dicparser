/*****************************************************************************
 * 
 * @(#)LERandomAccessFile.java  2009/11
 *
...
/**
 * LERandomAccessFile.java copyright (c) 1998-2009 Roedy Green, Canadian Mind
 * Products
 * 
 * @noinspection WeakerAccess
 */
final class LERandomAccessFile implements DataInput, DataOutput {
  // ------------------------------ FIELDS ------------------------------
   ...
   */
  public static final String EMBEDDED_COPYRIGHT = "copyright (c) 1999-2009 Roedy Green, Canadian Mind Products, http://mindprod.com";
   ...
   * @param rw like {@link java.io.RandomAccessFile} where "r" for read "rw" for
   * read and write, "rws" for read-write sync, and "rwd" for read-write dsync.
   * Sync ensures the physical i/o has completed befor the method returns.
   ...
   * @param off offset into the array to place the bytes, <b>not</b> offset in
   * file.
  ...
  public final long readLong() throws IOException{
    ...
    (long) (work[6] & 0xff) << 48 | (long) (work[5] & 0xff) << 40 | (long) (work[4] & 0xff) << 32
        ...
        | (long) (work[1] & 0xff) << 8 | (long) (work[0] & 0xff);
  }
   ...
   * 
   * @param v char to write. like RandomAcessFile.writeChar. Note the parm is an
   * int even though this as a writeChar
   * @throws IOException if read fails.
   */
