...
public class AddLicense {
  ...
  public static void main(String[] args){
    String rootFolder = "D:/Jin/Work/WorkSpace/Util/src";
    String licenseFile = "D:/Jin/Work/WorkSpace/Dictionary/src/license.txt";
  ...
  public static void addLicense(File file, byte[] licenseData){
    ...
    try{
      ...
      if(fileData[0] == '/' && fileData[1] == '*') return;
  ...
  private static void replaceTags(File file) throws IOException{
    ...
    while((line = br.readLine()) != null){
      ...
      if(line.indexOf("@date@") != -1) line = line.replaceFirst("@date@", "2009/11");
      bw.write(line);
      bw.write("\r\n");
    }
    br.close();
