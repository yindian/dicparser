/*****************************************************************************
 * 
 * @(#)KSVoiceDataEngineSimpleTest.java  2009/03
 *
...
public class KSVoiceDataEngineSimpleTest extends TestCase {

  KSVoiceDataEngineSimple ksVoiceS = null;
  public void testGetVoiceDataOffset() throws IOException, BadFormatException{
    if(ksVoiceS == null) ksVoiceS = new KSVoiceDataEngineSimple(TestFolderConfig.v_original);
    String word;
    int offset;
    for(int i = 0; i < VoiceDataBase.words.length; i++){
      word = VoiceDataBase.words[i];
      offset = ksVoiceS.getVoiceDataOffset(word);
